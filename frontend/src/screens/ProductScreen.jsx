...
const ProductScreen = ({ product }) => {
    return (
        ...
        // <div className='w-full bg-slate-500 grid grid-cols-4 gap-4 p-5 '>

        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <Link to={`/product/${product._id}`} className='flex justify-center'>
                <img className=" rounded-t-lg h-[200px] z-20" src={product.image} alt="" />
            </Link>

            <div className="p-5">
                <Link className={`/product/${product._id}`}>
