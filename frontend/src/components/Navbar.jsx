...
const Navbar = () => {
  ...
  return (
    <div className="w-full flex  h-[80px] bg-slate-900  text-white shadow-black shadow-xl sticky top-0 z-50 rounded-b-md">
      <div className="mx-auto w-full px-4 py-5 flex justify-between items-center max-w-[1240px] space-x-24 sm:px-16">
        <Link to='/'>
            ...
            <div class="hs-dropdown relative inline-flex">
              ...
              <div class=" hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[15rem] bg-white shadow-md rounded-lg p-2 mt-2 dark:bg-gray-800 dark:border dark:border-gray-700" aria-labelledby="hs-dropdown-with-header">
                <div class="py-3 px-5 -m-2 bg-gray-100 rounded-t-lg dark:bg-gray-700">
                  ...
                  <p class="text-sm font-medium text-gray-800 dark:text-gray-300">{userInfo.email}</p>
                </div>
                <div class="mt-2 py-2 first:pt-0 last:pb-0">
                  ...
                  <a onClick={logoutHandler} class="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300" href="#">
                    <svg class="flex-none" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
